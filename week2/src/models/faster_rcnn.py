...
class FasterRCNN:
    def __init__(self, box_score_thresh: float=0.9):
        """FasterRCNN model using ResNet50 FPN backbone.
        ...
        self.model = fasterrcnn_resnet50_fpn_v2(weights=self.weights, box_score_thresh=self.box_score_thresh)
        self.model.eval()
